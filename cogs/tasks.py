...
class autoTasks(commands.Cog):
    ...
    async def ctaannouncer(self) -> None:
        message= f"{self.bot.guilds[0].get_role(938924221554389014).mention}\n\nCTA is approaching - This is likely **mandatory** content. Time to wind down what you are doing and get ready to go to the K I N G M A K E R island.\n\nAttendance will be taken."
